...
-(void)createUI
{
    UIImageView * topImgView = [[UIImageView alloc]initWithFrame:CGRectMake(0, AutoHeight(30), AutoWidth(170), AutoHeight(15))];
    topImgView.center = CGPointMake(self.contentView.center.x, AutoHeight(20));
    topImgView.image = [UIImage imageNamed:@"hotshop"];
    [self addSubview:topImgView];
    
    UILabel * titleLabel = [CommUtls createLabelWithTitle:@"热门商家" fontSize:Font_Thirteen_S textColor:COLOR_BlackColor];
...
- (void)createShops
{
    ...
    for (int i = 0; i < totalnum; i ++) {
        ...
        chooseBtn.frame = CGRectMake(btnLeft, AutoHeight(57), AutoWidth(91), AutoHeight(90));
