...
@implementation CommitContentTableViewCell
...
//    topImgView.layer.cornerRadius = AutoWidth(23);
    ...
    zanBtn.frame = CGRectMake(lineView.right-AutoWidth(40), AutoHeight(80), AutoWidth(40),AutoHeight(15) );
